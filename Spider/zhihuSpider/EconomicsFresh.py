...
def main():
    #基础链接已准备好
    baseurl = "https://www.zhihu.com/question/26733648/answer/1532027746"
    datalist = []
    getData(baseurl)
...
def write_to_excel(datalist):
    ...
    workbook = copy(rb)
    worksheet = workbook.add_sheet("经济学入门")
    worksheet.write(0,0,"书名")
    worksheet.write(0,1,"推荐介绍")
